...
**Mục tiêu:** Kích hoạt "Người Dẫn Đường" (Onboarding Wizard) để chuyển giao hệ thống FreeUp Content Agent cho một nhân sự mới hoặc tổ chức mới. 
...
### Lời Chào Mở Đầu:
AI tự động chào mừng người dùng đến với Cỗ Máy FreeUp Content Agent và thông báo quy trình cài đặt sẽ diễn ra trong 4 bước đơn giản. Mời người dùng bắt đầu Bước 1.
...
- Kêu gọi người dùng tham khảo tài liệu [GUIDE.md](file:///Users/hoangbatau/Desktop/Vibe%20Coding/FreeUp%20Content%20Agent/GUIDE.md) nằm ở thư mục gốc nếu muốn vọc sâu hơn các bí thuật Cỗ Máy.
